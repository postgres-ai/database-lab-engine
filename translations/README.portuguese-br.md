...
- Versões _major_ do PostgreSQL suportadas: 9.6–17.
...
## Licença
O código fonte do DLE está licensiado pela licença de código aberto [Apache 2.0](https://opensource.org/license/apache-2-0/), aprovada pela OSI.
