        ...
        <div className={classes.container}>
          ...
          <div className={classes.summary}>
                ...
                <Tooltip
                  content={
                    <>
                      ...
                      of a&nbsp; thin clone. On creation there is no diff
                      between clone’s&nbsp; and initial data state, all data
                      blocks match. During work&nbsp; with the clone data
                      diverges and data diff size increases.
                      <br />
                      <br />
                      <strong>Clone creation time</strong> is time which
                      was&nbsp; spent to provision the clone.
                    </>
                  }
                >
                  {icons.infoIcon}
              ...
              <>
                ...
                {sshPortForwardingUrl && (
                  <div className={classes.fieldBlock}>
                    In a separate console, set up SSH port forwarding (and keep
                    it running):
            ...
            <p>
              ...
              <span className={classes.remark}>
                ...
                is also disabled.
                <br />
                Please be careful: abandoned clones with this checkbox enabled
                may cause out-of-disk-space events. Check disk space on daily
                basis and delete this clone once the work is done.
              </span>
            </p>
          ...
          <div className={classes.snippetContainer}>
            <SectionTitle
              tag="h2"
              level={2}
              text={'Reset clone using the CLI'}
            />
            ...
            />
            <p className={classes.tooltip}>
              You can destroy the clone using the CLI using the following
              command:
            </p>
            <SyntaxHighlight
              content={getCliDestroyCloneCommand(props.cloneId)}
            />
            ...
            <SyntaxHighlight
              content={getCreateSnapshotCommand(props.cloneId)}
            />
          </div>
